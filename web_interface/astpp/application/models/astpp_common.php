...
//        }
//        if (!isset($accountinfo['posttoexternal']))
//            $accountinfo['posttoexternal'] = 0;
//        if (!isset($accountinfo['firstname']))
//            $accountinfo['firstname'] = "";
//        if (!isset($accountinfo['lastname']))
//            $accountinfo['lastname'] = "";
//        if (!isset($accountinfo['middlename']))
//            $accountinfo['middlename'] = "";
//        if (!isset($accountinfo['reseller']))
//            $accountinfo['reseller'] = "";
//        if (!isset($accountinfo['company']))
//            $accountinfo['company'] = "";
//        if (!isset($accountinfo['address1']))
//            $accountinfo['address1'] = "";
//        if (!isset($accountinfo['address2']))
//            $accountinfo['address2'] = "";
//        if (!isset($accountinfo['postal_code']))
//            $accountinfo['postal_code'] = "";
//        if (!isset($accountinfo['province']))
//            $accountinfo['province'] = "";
//        if (!isset($accountinfo['city']))
//            $accountinfo['city'] = "";
//        if (!isset($accountinfo['country']))
//            $accountinfo['country'] = "";
//        if (!isset($accountinfo['telephone1']))
//            $accountinfo['telephone1'] = "";
//        if (!isset($accountinfo['telephone2']))
//            $accountinfo['telephone2'] = "";
//        if (!isset($accountinfo['facsimile']))
//            $accountinfo['facsimile'] = "";
//        if (!isset($accountinfo['email']))
//            $accountinfo['email'] = "";
//        if (!isset($accountinfo['currency']))
//            $accountinfo['currency'] = "";
//        if (!isset($accountinfo['maxchannels']))
//            $accountinfo['maxchannels'] = "";
//        if (!isset($accountinfo['timezone']))
//            $accountinfo['timezone'] = "";
//        if (!isset($accountinfo['language']))
...
//            $trunk = "N/A";
//        if (!$uniqueid)
//            $uniqueid = gettext("N/A");
//        if (!$pricelist)
//            $pricelist = gettext("N/A");
//        if (!$pattern)
//            $pattern = gettext("N/A");
//        $status = 0;
//
...
//        } elseif ($type == 0 || !$type) {
//            $tmp =
//                    "SELECT number FROM accounts WHERE status < 2 AND type = 0 AND reseller_id = "
//                    . $this->quote($reseller)
//                    . " ORDER BY number";
//            //print STDERR "$tmp\n";
//        } elseif ($type > 0) {
//            $tmp =
//                    "SELECT number FROM accounts WHERE status < 2 AND type = '$type' AND reseller_id = "
//                    . $this->quote($reseller)
//                    . " ORDER BY number";
//            //print STDERR "$tmp\n";
//        }
...
//        $accounts = array();
//        $q = "SELECT number FROM accounts WHERE status < 2 AND reseller_id = '" . $this->db->escape_str($reseller) . "'  ORDER BY number";
//        $query = $this->db->query($q);
//        if ($query->num_rows() > 0) {
//            foreach ($query->result_array() as $row) {
//                $accounts[] = $row['number'];
...
//            }
//        }
//        if ($cardinfo['value'] - $cardinfo['used'] < 100) {    # don't allow this if the card is down to the last penny.
