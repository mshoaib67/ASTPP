...
//    var columns = col_field.length;
//    var padding = 12;
//    var action_menu = 140;
//    var grid_width = $('.autoht').width();
//    
//    alert(grid_width);    
//    
...
// 	    alert("{display:"+collumn_property[0]+", name:"+collumn_property[0]+", width:"+collumn_property[1]+" , sortable: 'false', align: 'center'}");
	    jsonObj.push({display:collumn_property[0], name: collumn_property[0], width: collumn_property[1],  align: 'center'});
	}
    }
    return jsonObj;
  }
	...
	if(btn_field[i] !=""){
	    ...
	    button_property = btn_str.toString().split(',');
            if(button_property[4] == 'popup'){
                jsonObj.push({name: button_property[0], bclass: button_property[1],btn_url:button_property[3], onpress: button_action_popup});
            }else{
                jsonObj.push({name: button_property[0], bclass: button_property[1],btn_url:button_property[3], onpress: button_action});
            }
	}
    }
    return jsonObj;
